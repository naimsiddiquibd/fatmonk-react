                ...
                <div className='font-poppins z-30 lg:w-[1180px] px-4'>
                    ...
                    <div className='mt-12 text-center flex items-center gap-3 lg:justify-between justify-center '>
                        ...
                        <div className='lg:mr-8'>
                            <h1 className='text-monkwhite font-semibold text-3xl lg:text-[60px] lg:leading-[60px]'>Wordpress Developer</h1>
                        </div>
                        <div></div>
                    </div>
                    ...
                    <div className='p-3 mt-6'>
                        <p className='text-sm lg:text-lg text-monkwhite'>
                            Are you a WordPress wizard with a passion for building dynamic websites? Fatmonk Studio is looking for a WordPress Developer to join our team. If you have experience in theme and plugin development and are eager to explore platforms like Shopify and Webflow, we’d love to connect with you!
                        </p>
                        <div className='mt-6'>
                            ...
                            <p className='text-sm lg:text-lg text-monkwhite mt-3'>
                                <ul className='list-disc pl-4'>
                                    <li>Design, develop, and maintain custom WordPress websites.</li>
                                    <li>Create and customize WordPress themes and plugins.</li>
                                    <li>Troubleshoot and optimize WordPress sites for performance and security.</li>
                                    <li>Collaborate with designers and other developers to deliver seamless user experiences.</li>
                                    <li>Explore and implement solutions using Shopify and Webflow for diverse client needs.</li>
                                </ul>
                            </p>
                        </div>
                        ...
                        <div className='mt-6'>
                            ...
                            <p className='text-sm lg:text-lg text-monkwhite mt-3'>
                                <ul className='list-disc pl-4'>
                                    <li>Strong understanding of WordPress architecture and best practices.</li>
                                    <li>Proficiency in developing and customizing WordPress themes and plugins.</li>
                                    <li>Solid experience with HTML, CSS, JavaScript, and PHP.</li>
                                    <li>Familiarity with responsive and mobile-first design principles.</li>
                                </ul>
                            </p>
                        </div>

                        <div className='mt-6'>
                            <h2 className='text-xl lg:text-3xl font-poppins font-semibold text-monkwhite'>Additional Skills (Bonus)</h2>
                            <p className='text-sm lg:text-lg text-monkwhite mt-3'>
                                <ul className='list-disc pl-4'>
                                    <li>Experience working with Shopify and Webflow platforms.</li>
                                    <li>Knowledge of e-commerce development and integrations.</li>
                                    <li>Familiarity with SEO and site performance optimization.</li>
                        ...
                        <div className='mt-6'>
                            ...
                            <p className='text-sm lg:text-lg text-monkwhite mt-3'>
                                <ul className='list-disc pl-4'>
                                    ...
                                    <li>Minimum 1-2 years of professional WordPress development experience.</li>
                                    <li>Strong portfolio of WordPress projects (GitHub/Live links preferred).</li>
                                </ul>
                            </p>
                        </div>

                        <div className='mt-6'>
                            <h2 className='text-xl lg:text-3xl font-poppins font-semibold text-monkwhite'>Compensation & Benefits</h2>
                            <p className='text-sm lg:text-lg text-monkwhite mt-3'>
                                <ul className='list-disc pl-4'>
                        ...
                        <div className='mt-6'>
                            <h2 className='text-xl lg:text-3xl font-poppins font-semibold text-monkwhite'>How to Apply</h2>
                            <p className='text-sm lg:text-lg text-monkwhite mt-3'>
                                Send your CV and portfolio link to <a href="mailto:career@fatmonk.studio" className='text-monkblue'>career@fatmonk.studio</a> with the subject line: <b>"WordPress Developer Application"</b>. Let’s build amazing websites together! 🚀
                            </p>
                        </div>
                    </div>
