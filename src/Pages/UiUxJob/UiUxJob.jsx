        ...
        <div className="font-poppins z-30 lg:w-[1180px] px-4">
          ...
          <div className="p-3 mt-6">
            <p className="text-sm lg:text-lg text-monkwhite">
              Fatmonk Studio is on the hunt for a UI/UX Designer! 🎨💻 If you're
              a wizard with pixels and have a knack for crafting seamless user
              experiences, we want you on our team!
            </p>
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  ...
                  <li>
                    Dive deep into user needs and research to design smooth,
                    intuitive experiences.
                  </li>
                  <li>
                    Create stunning UI designs for web and mobile apps using
                    Figma and Adobe XD.
                  </li>
                  <li>
                    Develop user flows and wireframes to lay a solid foundation
                    for our apps.
                  </li>
                  <li>
                    Bring our apps to life with high-fidelity mockups in Adobe
                    Photoshop and Illustrator.
                  </li>
                  <li>
                    Keep the team aligned with quick mockups and presentations
                    using Canva.
                  </li>
                  <li>
                    Collaborate closely with developers and product managers to
                    realize our vision.
                  </li>
                </ul>
              </p>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  ...
                  <li>
                    Proficiency in Figma, Adobe XD, Photoshop, and Illustrator.
                  </li>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  <li>
                    Ability to simplify complex ideas into user-friendly
                    interfaces.
                  </li>
                  <li>
                    Passion for creating beautiful and functional digital
                    experiences.
                  </li>
                  <li>
                    Experience in graphics design, including 3D and 2D sketching
                    is a plus.
                  </li>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                To apply email your website/dribble profile link/portfolio link
                with an updated CV to career@fatmonk.studio{" "}
                <b>“UI UX Designer"”</b> in the subject line.Let's create
