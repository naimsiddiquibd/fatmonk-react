...
const InternDeveloper = () => {
  return (
    <div>
      <Helmet>
        <title>Intern Developer Position - Fatmonk</title>
        ...
        <div className="font-poppins z-30 lg:w-[1180px] px-4">
          ...
          <div className="p-3 mt-6">
            <p className="text-sm lg:text-lg text-monkwhite">
              Are you a passionate tech enthusiast with a hunger to learn and
              grow? Fatmonk Studio is excited to bring on a Developer Intern to
              join our dynamic team. If you're eager to enhance your skills in
              MERN, Laravel, React, and Next.js, we want to hear from you!
            </p>
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  <li>
                    Assist in building and maintaining web applications using
                    the MERN stack and Laravel framework.
                  </li>
                  <li>
                    Develop and optimize front-end features with React and
                    Next.js.
                  </li>
                  <li>
                    Debug, test, and troubleshoot across various stages of
                    development.
                  </li>
                  <li>
                    Collaborate with senior developers to bring innovative ideas
                    to life.
                  </li>
                  <li>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  <li>
                    Basic understanding of MERN stack development (MongoDB,
                    Express, React, Node.js).
                  </li>
                  <li>
                    Foundational knowledge of Laravel for backend development.
                  </li>
                  <li>
                    Familiarity with React concepts and a willingness to explore
                    Next.js.
                  </li>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  ...
                  <li>
                    Interest in exploring cloud platforms (AWS, Firebase, etc.).
                  </li>
                </ul>
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <li>
                  Pursuing or recently completed a degree in Computer Science,
                ...
                <li>
                  Basic portfolio showcasing any personal or academic projects
                  (GitHub/Live links preferred).
                </li>
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                To apply email your updated CV to career@fatmonk.studio{" "}
                <b>“Intern Developer”</b> in the subject line. Let's create
