    ...
    <div>
      <Helmet>
        ...
        <meta
          ...
          content="We are looking for a Junior Developer who will work with our dedicated team. In this role, you will be responsible for the development and maintenance of our web-based applications."
        />
        ...
        <div className="font-poppins z-30 lg:w-[1180px] px-4">
          ...
          <div className="p-3 mt-6">
            <p className="text-sm lg:text-lg text-monkwhite">
              ...
              React) to join our team at Fatmonk. As a key member, you'll be
              instrumental in developing and maintaining our web-based
              applications.
            </p>
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  <li>
                    Collaborating with the development manager on software
                    design and coding tasks, with a focus on utilizing Laravel
                    for backend development and React for frontend development.
                  </li>
                  <li>
                    Participating in company development meetings and
                    contributing valuable insights.
                  </li>
                  <li>
                    Familiarize yourself with our codebase and continuously
                    enhance your coding proficiency, particularly in Laravel and
                    React.
                  </li>
                  <li>
                    Writing clean and efficient code while ensuring its
                    maintenance.
                  </li>
                  <li>
                    Addressing minor bugs and implementing fixes promptly.
                  </li>
                  <li>
                    Monitoring the technical performance of internal systems.
                  </li>
                  <li>
                    Monitoring the technical performance of our internal
                    systems.
                  </li>
                  <li>
                    GResponding to development team inquiries and requests.
                  </li>
                  <li>
                    Gathering feedback from users to improve program
                    functionality.
                  </li>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  ...
                  <li>
                    Extensive experience in frontend development using React.
                  </li>
                  <li>
                    Experience with relational databases, particularly MySQL,
                    including efficient database design and scaling.
                  </li>
                  <li>
                    Preferred experience in developing E-Commerce websites.
                  </li>
                  <li>
                    Knowledgeable about web services, including API development
                    and integration.
                  </li>
                  <li>
                    Basic understanding of server management, cPanel, and
                    hosting.
                  </li>
                </ul>
              </p>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                <ul className="list-disc pl-4">
                  <li>
                    Demonstrated eagerness to learn and adapt to new
                    technologies, including Redux for state management and other
                    relevant tools for React development.
                  </li>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm lg:text-lg text-monkwhite mt-3">
                ...
                with “Software Engineer (Laravel & React)” mentioned in the
                subject line.
              </p>
            </div>
          </div>
