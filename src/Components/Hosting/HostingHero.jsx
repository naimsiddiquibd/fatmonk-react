...
const HostingHerp = () => {
  ...
  return (
    <div
      className="hero min-h-[520px] sm:min-h-screen relative"
      style={{
        backgroundImage: 'url("/hosting_hero_grad.png")',
    ...
    >
      <div className="hero-content xl:max-w-[1800px] flex-col">
        <div className="hidden lg:inline right-0 z-10 absolute">
          <img
            className="w-[498px] border rounded-full border-transparent"
            src="/hosting_diamond.gif"
            alt=""
          />
        </div>
