  ...
  return (
    <div className="flex flex-col items-center justify-center bg-[#0E022C] py-32 mx-auto">
      <div>
        <div className="mb-10">
          ...
          >
            SSD Cloud Hosting (Standard) Plan
          </h2>
          ...
          <div className="relative hover:scale-110 transition-all">
            ...
            <div className="text-center bg-[#191139] p-5 rounded-xl mt-6 border-2 border-monkwhite border-opacity-5">
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-3">
                  <img className="h-6 w-6" src="/check-circle.png" alt="" />
                  <p className="text-sm text-monkwhite">10 GB SSD</p>
                </div>
                <div className="flex items-center gap-3">
                  <img className="h-6 w-6" src="/check-circle.png" alt="" />
                  <p className="text-sm text-monkwhite">2GB RAM</p>
    ...
    "
          ...
          <div className="relative hover:scale-110 transition-all">
            ...
            {/* Card area */}
            <div className="text-center bg-[#191139] p-5 rounded-xl mt-6 border-2 border-monkwhite border-opacity-5">
              <h2 className="text-2xl text-monkwhite">20 GB SSD</h2>
              <h1
                style={{
                  background: "linear-gradient(to right, #FFCC33, #E233FF)",
                  WebkitBackgroundClip: "text",
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-3">
                  <img className="h-6 w-6" src="/check-circle.png" alt="" />
                  <p className="text-sm text-monkwhite">20 GB SSD</p>
                </div>
                <div className="flex items-center gap-3">
                  <img className="h-6 w-6" src="/check-circle.png" alt="" />
                  <p className="text-sm text-monkwhite">2GB RAM</p>
    ...
    "
          ...
          <div className="relative hover:scale-110 transition-all">
            ...
            {/* Card area */}
            <div className="text-center bg-[#191139] p-5 rounded-xl mt-6 border-2 border-monkwhite border-opacity-5">
              <h2 className="text-2xl text-monkwhite">40 GB SSD</h2>
              <h1
                style={{
                  background: "linear-gradient(to right, #FFCC33, #E233FF)",
                  WebkitBackgroundClip: "text",
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-3">
                  <img className="h-6 w-6" src="/check-circle.png" alt="" />
                  <p className="text-sm text-monkwhite">40 GB SSD</p>
                </div>
                <div className="flex items-center gap-3">
                  <img className="h-6 w-6" src="/check-circle.png" alt="" />
                  <p className="text-sm text-monkwhite">2GB RAM</p>
    ...
    "
      ...
      <div className="lg:w-[1080px] flex flex-wrap items-center justify-center gap-3 mt-5 mx-1 lg:mx-0">
        <div className="border-2 rounded-full px-6 py-3 inline-flex items-center gap-2 mt-2 hover:scale-110 transition-all">
          <img src="/tik.png" alt="" />
          <p>100% SSD Disks</p>
        </div>
        <div className="border-2 rounded-full px-6 py-3 inline-flex items-center gap-2 mt-2 hover:scale-110 transition-all">
        ...
        <div className="border-2 rounded-full px-2 py-3 inline-flex items-center gap-2 mt-2 hover:scale-110 transition-all">
          <img src="/tik.png" alt="" />
          <p>Daily Backup</p>
        </div>
        <div className="border-2 rounded-full px-4 py-3 inline-flex items-center gap-2 mt-2 hover:scale-110 transition-all">
          <img src="/tik.png" alt="" />
