...
const WhatYouWillGet = () => {
    return (
        <div className='flext items-center bg-monkblack' style={{
            ...
            <h2 className='text-2xl text-monkwhite text-center py-20'>What will you get if you join us?</h2>
            <div className='grid lg:grid-cols-5 gap-3 lg:mx-32 pb-20'>
                <div className='flex flex-col items-center justify-center'>
                    <img className='h-28' src="/happy-client.png" alt="Happy Client Icon" />
                ...
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <h5 className='font-semibold text-monkwhite text-2xl mt-3'>Maximum</h5>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <img className='h-28' src="/live-support.png" alt="Happy Client Icon" />
