...
const Counter = () => {
    return (
        <>
            <div className='py-16 bg-[#000] inline lg:hidden'>
                <div className='lg:w-[1180px] lg:mx-auto'>
                    <div className='h-full lg:h-[500px] bg-contain bg-[#000] bg-no-repeat bg-center' style={{
                        ...
                        backgroundSize: '150%', // Adjust background size to make it slightly bigger
                    }}>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4  pb-16 gap-2 px-2 lg:px-0'>
                            <div className='backdrop-blur-sm bg-monkwhite/5 m-5 lg:m-2 px-6 lg:px-6 xl:px-6 py-7 rounded-2xl h-[280px] border-b-2'>
                    ...
                    Fatmonk Studio epitomizes innovation and excellence, crafting tailored solutions for a diverse clientele with unwavering commitment to client satisfaction.
                            ...
                            <div className='backdrop-blur-sm bg-monkwhite/ m-5 lg:m-2 px-6 lg:px-6 xl:px-6 py-7 rounded-2xl h-[280px] border-b-2'>
            ...
            <div className='py-16 bg-[#000] hidden lg:block'>
            <div className='lg:w-[1180px] lg:mx-auto relative'>
                <div className='h-full lg:h-[500px]'>
                    <video autoPlay loop muted className='w-full h-full object-cover absolute inset-0'>
                        <source src='Insight.mp4' type='video/mp4' />
