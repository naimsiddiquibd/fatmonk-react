    ...
    return (
        <div className="hero min-h-[520px] sm:min-h-screen bg-[#000] relative">
            ...
            <div className='hidden lg:inline right-0 z-10 absolute'>
                 <img className='w-[450px]' src="/branddesign.png" alt="" />
            </div>
            <div className='g:absolute lg:mx-auto lg:w-[1180px] z-40 md:col-span-9 lg:ml-0 mt-10'>
                 
             <h1 className='font-poppins font-bold text-monkwhite text-5xl lg:text-8xl my-1 lg:my-3'>Transform Your <br></br>Brand Design</h1>
