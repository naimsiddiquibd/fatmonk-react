    ...
    <div className="bg-monkblack">
      <footer className="footer p-6 lg:p-0 lg:py-10 lg:w-[1180px] lg:mx-auto   text-monkwhite font-poppins  lg:flex lg:items-strat lg:justify-between">
        <div>
          ...
          <div>
            <h3 className="font-semibold lg:mt-1 lg:text-[20px] text-xl w-full md:w-[370px] md:leading-8 mt-5">
              Transform Your Idea Into<br></br> Reality With{" "}
              <span className="text-monkwhite bg-gradient-to-r from-[#4444C4] to-[#FF003D] bg-clip-text text-transparent">
                Fatmonk
              </span>
            </h3>
        ...
        <div className="md:flex md:justify-between lg:flex lg:items-top gap-4 lg:gap-24 2xl:text-[18px]">
          ...
          <nav className="hidden lg:inline">
            ...
            <div className="flex flex-col lg:gap-2 mt-3 text-sm">
              <p>Web Development</p>
          ...
          <nav className="">
            <h6 className="font-bold text-lg">Office Location</h6>
            ...
            <div className="flex items-center gap-2 text-sm mt-3">
              ...
              <p className="max-w-xs leading-5">
                Level 3, House 06 Rd No.28
                <br></br>Dhaka 1212, Bangladesh
              </p>
            </div>
          </nav>

          <nav className="flex flex-col gap-1 mt-5 lg:mt-0 lg:gap-0 xl:gap-3">
            <p className="font-bold text-4xl lg:text-[23px]">+8801722723891</p>
            <div className="flex items-center gap-3 mt-2 lg:mt-0">
              <a
                href="tel:+8801722723891"
                className="flex items-center gap-1 cursor-pointer text-sm"
              >
                <IoIosCall className="lg:text-sm text-2xl"></IoIosCall>
                <p className="lg:text-sm text-xl">Call Now</p>
              </a>
              <a
                href="https://wa.me/+8801722723891"
                className="flex items-center gap-1 cursor-pointer text-sm"
              >
                <FaWhatsapp className="lg:text-sm text-2xl"></FaWhatsapp>
                <p className="lg:text-sm text-xl">WhatsApp</p>
              </a>
            </div>
            <div className="">
              <div className="flex items-center gap-2 text-sm lg:mt-0 mt-2">
                <EnvelopeIcon className="size-6 text-blue-500" />
                <p>wakil@fatmonk.studio</p>
              </div>
            </div>
          </nav>
        </div>
      ...
      <footer className="footer gap-y-2 p-10 lg:p-0 lg:py-10  items-center  bg-monkblack text-monkwhite flex flex-col lg:flex-row lg:justify-between text-[12px] md:text-[14px] lg:text-[14px] xl:text-[16px] lg:w-[1180px] lg:mx-auto text-sm">
        <aside className="items-center grid-flow-col text-center">
          <p>Copyright © 2025 Fatmonk Studio - All right reserved</p>
        </aside>
