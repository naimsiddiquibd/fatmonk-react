        ...
        <div className='bg-monkblack'>
            <footer className="footer p-6 lg:p-0 lg:py-10 lg:w-[1180px] lg:mx-auto   text-monkwhite font-poppins  lg:flex lg:items-strat lg:justify-between">
                <div>
                    ...
                    <div>
                        <h3 className='font-semibold lg:mt-1 lg:text-[20px] text-xl w-full md:w-[370px] md:leading-8 mt-5'>Transform Your Idea Into<br></br> Reality With <span className='text-monkwhite bg-gradient-to-r from-[#4444C4] to-[#FF003D] bg-clip-text text-transparent'>Fatmonk</span></h3>
                ...
                <div className='md:flex md:justify-between lg:flex lg:items-top gap-4 lg:gap-24 2xl:text-[18px]'>
                    ...
                    <nav className=''>
                        ...
                        <div className='flex items-center gap-2 text-sm mt-3'>
                                ...
                                <p className='max-w-xs leading-5'>Level 3, House 06 Rd No.28
                                    <br></br>Dhaka 1212, Bangladesh</p>
                            </div>
