            ...
            <div className="hero-content lg:w-[1180px] flex-col lg:flex-row lg:mx-auto">
                ...
                <div>
                    ...
                    className='grid grid-cols-1 px-7'>
                        ...
                        <div>
                            <p className='text-sm lg:text-lg  lg:leading-[30px] font-poppins font-normal text-monkwhite mt-2 leading-5 md:text-left text-center'>Ready to take your business to the next level? Our team of experts is here to collaborate with you, bringing fresh ideas and modern solutions to the table. Whether you need to boost your online presence, streamline your software, create stunning designs, or plan unforgettable events, we've got the expertise you need.</p>
                        </div>
                    </motion.div>
                </div>
                <motion.img
