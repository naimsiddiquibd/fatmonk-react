    ...
    return (
        <div className="hero min-h-[520px] sm:min-h-screen bg-[#000] relative">
            ...
            <div className='g:absolute lg:mx-auto lg:w-[1180px] z-40 md:col-span-9 lg:ml-0 mt-10'>
             ...
             <h1 className='font-poppins font-bold text-monkwhite text-5xl lg:text-8xl my-1 lg:my-3'>Elevate Your <br></br>UI UX Design Journey</h1>
             <h2 className='font-poppins text-sm lg:text-lg text-monkwhite w-84'>Your website should convert, not confuse your visitors. A perfect blend of good user experience and aesthetic design can ignite growth - we will help you get there.</h2>
