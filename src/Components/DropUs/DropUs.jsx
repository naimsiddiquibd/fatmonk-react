...
const DropUs = ({ type = "black" }) => {
  return (
    <div
      className={`flex justify-center py-20 ${
        type === "black" ? "bg-[#0D0D0D]" : "bg-monkwhite"
      }`}
    >
      <div
        style={{
      ...
      >
        <div className="lg:px-20 lg:py-20 px-6 py-5 rounded-lg lg:w-[1180px] bg-[#121120] shadow-md shadow-[#423359c9]">
          <h3 className="text-monkwhite text-3xl lg:text-4xl">
            Drop us a line or Share a Project Idea{" "}
          </h3>
          <p className="text-monkwhite text-lg lg:text-xl mt-3 lg:my-9 lg:w-[880px]">
            ...
            company looking to elevate your design, Fatmonk Studio is here to
            help. We’d love to discuss your project and explore how we can bring
            your vision to life. 💜
          </p>
          <Link to="/contact">
            <button
